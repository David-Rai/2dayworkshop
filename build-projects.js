        ...
        <section id="student-projects" class="py-20 border-t border-brand-border w-full">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                <div>
                    ...
                    <p class="text-brand-textmuted">Amazing projects built by students during the 2 Days Web Development Workshop.</p>
                </div>
                <!-- Search Component -->
                <div class="relative w-full md:w-72 shrink-0">
                    <input type="text" id="project-search" placeholder="Search projects..."
                        class="w-full bg-brand-surface border border-brand-border text-brand-text text-sm rounded-lg py-2.5 pl-10 pr-4 focus:outline-none focus:border-white/40 transition-colors placeholder:text-brand-textmuted">
                    <svg class="w-4 h-4 text-brand-textmuted absolute left-3.5 top-3" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
